...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${isDark ? 'bg-gray-900/95' : 'bg-white/95'} backdrop-blur-md sticky top-0 z-50 border-b ${
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            <span
              className={`text-2xl md:text-3xl font-bold font-handwritten ${
        ...
        {isOpen && (
          ...
          >
            ...
            {/* Social Links - Mobile */}
            <div
              className={`flex justify-center gap-3 pt-4 mt-4 border-t ${
                isDark ? 'border-gray-800' : 'border-gray-200'
              }`}
            >
              {socialLinks.map((social, idx) => (
