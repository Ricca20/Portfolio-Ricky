...
import {
  FaReact, FaNodeJs, FaJs, FaDocker, FaGitAlt, FaDatabase, FaJava, FaHtml5, FaCss3Alt,
} from 'react-icons/fa';
import {
  SiTypescript, SiTailwindcss, SiMongodb, SiPostgresql, SiFirebase, SiExpress, SiGraphql,
  SiNextdotjs, SiSpring, SiMysql, SiVercel, SiVite, SiPostman, SiFigma, SiGithub, SiNpm,
} from 'react-icons/si';
