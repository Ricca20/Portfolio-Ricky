...
import { FiExternalLink, FiGithub, FiFigma, FiDownload } from 'react-icons/fi';
  ...
  const allProjects: Project[] = [
    {
      ...
      links: { github: 'https://github.com/nethal17/Healthcare-System', live: '#' },
    },
    {
      _id: '2',
      title: 'Rajapaksha Foods – Campus Food Delivery Platform',
      description:
        'Campus-focused food delivery system for SLIIT students and staff, enabling fast and affordable meal ordering. Includes order tracking, QR payments, analytics dashboards, and blockchain-based salary records for staff.',
    ...
    },
    {
      ...
      description:
        'Dynamic MERN web application connecting farmers with recyclers and buyers to promote sustainable agri-waste reuse. Features include marketplace listings, inventory management, financial tracking, and delivery coordination.',
    ...
    },
    {
      ...
      description:
        'A platform for travelers with disabilities in Sri Lanka, featuring AI-powered accessibility recommendations, route planning, and hotel/public space reviews filtered by accessibility standards.',
      ...
      links: {
        ...
        figma:
          'https://www.figma.com/design/V1gYjBLCQuKqRIlXWlHAsy/AccessLanka-Mobile-App?node-id=2002-2&t=ElNIyAkON5ilYQXb-1',
        live: '#',
      },
    },
    {
      ...
      description:
        'Mobile finance tracker for users to record daily transactions, set monthly budgets, and visualize expenses by category.',
      ...
      links: { github: 'https://github.com/Ricca20/Finance_Tracker-Mobile-App.git', apk: '#' },
    },
    {
      _id: '6',
      title: 'MedStream – Healthcare Microservices Platform',
      description:
        'A microservices-based healthcare platform featuring specialized Payment and Notification services. Designed for high reliability, financial integrity, and multi-channel user engagement.',
      ...
      links: { github: 'https://github.com/yasindu-tech/MedStream.git', live: '#' },
    },
    {
      _id: '7',
      title: 'Accessmap – Accessibility Review & Discovery',
      description:
        'An accessibility-focused discovery platform that empowers the community to rate and review locations based on specific accessibility needs like wheelchair access, visual, and hearing support.',
              ...
              {currentProjects.map((project) => (
                ...
                >
                  ...
                  <p
                    ...
                    } text-sm leading-relaxed mb-4 font-body`}
                  >
                    {project.description}
                  </p>
          ...
          >
            ...
            <div
              className={`absolute left-1/2 -translate-x-1/2 bottom-[-8px] w-0 h-0 border-l-8 border-r-8 border-t-8 ${
                isDark
                  ? 'border-l-transparent border-r-transparent border-t-cyan-400'
                  : 'border-l-transparent border-r-transparent border-t-cyan-600'
              }`}
            />
          </motion.div>
        )}
