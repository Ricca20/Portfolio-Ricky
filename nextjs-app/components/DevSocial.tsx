...
const DevSocial = () => {
  ...
  const socialLinks = [
    { name: 'GitHub', icon: <FaGithub />, url: 'https://github.com/Ricca20' },
    { name: 'LinkedIn', icon: <FaLinkedin />, url: 'https://www.linkedin.com/in/ricky-perera-355678340/' },
    { name: 'Stack Overflow', icon: <FaStackOverflow />, url: 'https://stackoverflow.com/users/yourusername' },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="w-full overflow-x-auto">
            ...
            <img
              src={`https://ghchart.rshah.org/${isDark ? '22d3ee' : '0891b2'}/Ricca20`}
