...
const Hero = () => {
  ...
  return (
    <section
      ...
      } flex items-start pt-24 md:pt-32 px-4 sm:px-6 lg:px-8 transition-colors duration-300`}
    >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          >
            ...
            <div className="mb-8">
              ...
              >
                Building, breaking, and perfecting full-stack applications and intelligent
                platforms — fueled by creativity, coffee, and problem-solving, with AI and
                automation to make technology smarter.
              </p>
            </div>
