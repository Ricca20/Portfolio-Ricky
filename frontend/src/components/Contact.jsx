...
const Contact = () => {
  ...
  const { loading, error, success, submit } = useFormSubmit(
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            <p className={`${isDark ? 'text-gray-300' : 'text-gray-700'} text-sm md:text-base mb-4 font-body`}>
            ...
            <a 
              ...
              className={`${isDark ? 'text-cyan-400 hover:text-cyan-300' : 'text-cyan-600 hover:text-cyan-500'} text-base md:text-lg font-medium transition-colors font-body`}
            >
